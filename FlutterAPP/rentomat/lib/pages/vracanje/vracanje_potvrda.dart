...
class vracanje_potvrda extends StatefulWidget {
  final String text;
  const vracanje_potvrda({Key? key, required this.text}) : super(key: key);

  @override
  State<vracanje_potvrda> createState() => _vracanje_potvrdaState();
}

class _vracanje_potvrdaState extends State<vracanje_potvrda> {

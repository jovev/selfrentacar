...
import 'package:rentomat/pages/vracanje/vracanje_kljuc.dart';
...
class vracanje_sugestije extends StatefulWidget {
  final String text;
  const vracanje_sugestije({Key? key, required this.text}) : super(key: key);

  @override
  State<vracanje_sugestije> createState() => _vracanje_sugestijeState();
}

class _vracanje_sugestijeState extends State<vracanje_sugestije> {
              ...
              children: [
                ...
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    primary:
                        const Color.fromARGB(255, 249, 133, 6), // background

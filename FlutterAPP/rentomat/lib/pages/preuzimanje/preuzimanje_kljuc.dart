...
class preuzimanje_kljuc extends StatefulWidget {
  final String text;
  const preuzimanje_kljuc({Key? key, required this.text}) : super(key: key);

  @override
  State<preuzimanje_kljuc> createState() => _preuzimanje_kljucState();
}

class _preuzimanje_kljucState extends State<preuzimanje_kljuc> {
            ...
            Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Image.asset('assets/img/pick_up.png')),
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                ...
                Container(
                    height: MediaQuery.of(context).size.height * 0.1,
                    child: Image.asset('assets/img/arrow_down.jpg')),
              ],
            ),
          ],
        ),
